...
SOURCEFILES_QUOTED_IF_SPACED=main.c Configware.c Regulator.c globals.c consigne.c odoLibre.c GenerTraj.c mouvements.c ../Canlib/CanDspic.c ../Canlib/CanInterruptsDspic.c ../Peripherals/pps.c ../Peripherals/pwm.c ../Peripherals/timers.c BLDC.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/Configware.o ${OBJECTDIR}/Regulator.o ${OBJECTDIR}/globals.o ${OBJECTDIR}/consigne.o ${OBJECTDIR}/odoLibre.o ${OBJECTDIR}/GenerTraj.o ${OBJECTDIR}/mouvements.o ${OBJECTDIR}/_ext/2095456260/CanDspic.o ${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o ${OBJECTDIR}/_ext/1094685832/pps.o ${OBJECTDIR}/_ext/1094685832/pwm.o ${OBJECTDIR}/_ext/1094685832/timers.o ${OBJECTDIR}/BLDC.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/Configware.o ${OBJECTDIR}/Regulator.o ${OBJECTDIR}/globals.o ${OBJECTDIR}/consigne.o ${OBJECTDIR}/odoLibre.o ${OBJECTDIR}/GenerTraj.o ${OBJECTDIR}/mouvements.o ${OBJECTDIR}/_ext/2095456260/CanDspic.o ${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o ${OBJECTDIR}/_ext/1094685832/pps.o ${OBJECTDIR}/_ext/1094685832/pwm.o ${OBJECTDIR}/_ext/1094685832/timers.o ${OBJECTDIR}/BLDC.o

# Source Files
SOURCEFILES=main.c Configware.c Regulator.c globals.c consigne.c odoLibre.c GenerTraj.c mouvements.c ../Canlib/CanDspic.c ../Canlib/CanInterruptsDspic.c ../Peripherals/pps.c ../Peripherals/pwm.c ../Peripherals/timers.c BLDC.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/PropBoard2014-BLDC.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/2095456260/CanDspic.o: ../Canlib/CanDspic.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../Canlib/CanDspic.c  -o ${OBJECTDIR}/_ext/2095456260/CanDspic.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2095456260/CanDspic.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -fast-math -save-temps=obj -O0 -I"CanLib" -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o: ../Canlib/CanInterruptsDspic.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../Canlib/CanInterruptsDspic.c  -o ${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -fast-math -save-temps=obj -O0 -I"CanLib" -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/BLDC.o: BLDC.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/BLDC.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  BLDC.c  -o ${OBJECTDIR}/BLDC.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/BLDC.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -fast-math -save-temps=obj -O0 -I"CanLib" -msmart-io=1 -Wall -msfr-warn=off
...
${OBJECTDIR}/_ext/2095456260/CanDspic.o: ../Canlib/CanDspic.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/2095456260/CanDspic.o.d 
	@${RM} ${OBJECTDIR}/_ext/2095456260/CanDspic.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../Canlib/CanDspic.c  -o ${OBJECTDIR}/_ext/2095456260/CanDspic.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2095456260/CanDspic.o.d"        -g -omf=elf -fast-math -save-temps=obj -O0 -I"CanLib" -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/2095456260/CanDspic.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o: ../Canlib/CanInterruptsDspic.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o.d 
	@${RM} ${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../Canlib/CanInterruptsDspic.c  -o ${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o.d"        -g -omf=elf -fast-math -save-temps=obj -O0 -I"CanLib" -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/_ext/2095456260/CanInterruptsDspic.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/BLDC.o: BLDC.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/BLDC.o.d 
	@${RM} ${OBJECTDIR}/BLDC.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  BLDC.c  -o ${OBJECTDIR}/BLDC.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/BLDC.o.d"        -g -omf=elf -fast-math -save-temps=obj -O0 -I"CanLib" -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/BLDC.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
dist/${CND_CONF}/${IMAGE_TYPE}/PropBoard2014-BLDC.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/PropBoard2014-BLDC.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -fast-math -save-temps=obj -Wl,,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/PropBoard2014-BLDC.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/PropBoard2014-BLDC.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -fast-math -save-temps=obj -Wl,,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/PropBoard2014-BLDC.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
